...
// import { handleReferral } from "./utils/referralHandler";
...
// import UserNewNftsPage from "./pages/UserNewNftsPage";
...
// const UserNftsPage = lazy(() => import("./pages/UserNftsPage"));
// const PurchasedTicketsPage = lazy(() => import("./pages/PurchasedTicketsPage"));
// const EarnedGifts = lazy(() => import("./pages/EarnedGiftsPage"));
...
//             <Route
//               path="/user-new-nfts"
//               element={<ProtectedAdminRoute element={UserNewNftsPage} />}
//             />
//             <Route
//               path="/user-nfts"
//               element={<ProtectedAdminRoute element={UserNftsPage} />}
//             />
//             <Route
//               path="/purchased-tickets"
//               element={<ProtectedAdminRoute element={PurchasedTicketsPage} />}
//             />
//             <Route
//               path="/earned-gifts"
//               element={<ProtectedAdminRoute element={EarnedGifts} />}
//             />
//             <Route
//               path="/user-list"
//               element={<ProtectedAdminRoute element={UserList} />}
//             />
//           </Route>
//         </Routes>
//       </Suspense>
...
//   useEffect(() => {
//     handleReferral(); // Uygulama yüklendiğinde referral parametresini işle
//   }, []);
...
// --- BEGIN: Token Expiry Check Wrapper ---
...
// This wrapper will redirect to /login if token is expired or missing
...
// --- END: Token Expiry Check Wrapper ---
