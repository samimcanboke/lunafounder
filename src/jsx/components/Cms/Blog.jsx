        ...
        <div className="col-xl-12">
          ...
          <div className="mb-3">
            <ul className="d-flex align-items-center flex-wrap">
              ...
              <li>
                <Link to={"/blog-cate"} className="btn btn-primary mx-1">
                  Blog Category
                </Link>
              </li>
              <li>
                <Link to={"#"} className="btn btn-primary mt-sm-0 mt-1">
                  Add Blog Category
                </Link>
              </li>
            </ul>
          ...
          <div className="filter cm-content-box box-primary mt-5">
            <div className={`content-title ${open2 ? "" : "collbord"}`}>
              <div className="cpa">Blogs List</div>
              <div className="tools">
                <Link
                  to={"#"}
                  className="expand SlideToolHeader"
                ...
                <div className="card-body">
                  <div className="table-responsive">
                        ...
                        {tableData.map((item, ind) => (
                          <tr key={ind}>
                            ...
                            <td>
                              <Link
                                to={"#"}
                                className="btn btn-secondary btn-sm content-icon me-1"
                              >
                    ...
                    <div className="d-flex align-items-center justify-content-lg-between flex-wrap justify-content-center">
                      <span className="mb-2 mb-xl-0 me-3">
                        Page 1 of 4, showing 2 records out of 8 total, starting
