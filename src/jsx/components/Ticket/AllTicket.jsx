                    ...
                    <tbody>
                      {ticketData.map((item, index) => (
                        <tr key={index}>
                          ...
                          <td>{item.date}</td>
                          <td>
                            <span className={`badge ${item.statusBdge}`}>
                              {item.status}
                            </span>
                          </td>
                          <td>
